  ...
  return (
    ...
    >
      <Dialog.Trigger
        ...
        className="rounded p-1 font-mono text-[11px] text-muted hover:bg-app hover:text-amber"
      >
        ✎
      </Dialog.Trigger>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-x-0 bottom-0 z-50 max-h-[92dvh] overflow-y-auto rounded-t-xl bg-card p-5 shadow-xl outline-none sm:inset-x-auto sm:top-1/2 sm:bottom-auto sm:left-1/2 sm:w-full sm:max-w-md sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-lg sm:p-6">
          ...
          <div className="mt-3 flex gap-2">
            <input
              ...
              className="w-full rounded-md border border-edge px-2.5 py-2 font-mono text-sm focus:outline-2 focus:outline-gold"
            />
            <datalist id={listId}>
              {suggestions
            ...
            <button
              type="button"
              onClick={() => add(input)}
              className="rounded-md border border-edge px-3 text-sm font-semibold text-fg hover:border-gold hover:text-amber"
            >
              Add
            </button>
          </div>
